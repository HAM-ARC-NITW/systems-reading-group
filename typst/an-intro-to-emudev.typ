...
#slide[
  #place(top + center, dx: -280pt, dy: 50pt, image("../public/images/nes.webp", width: 250pt))
  #place(top + center, dx: -90pt, dy: 50pt, image("../public/images/gameboy.png", width: 120pt))
  #place(top + center, dx: 30pt, dy: 70pt, image("../public/images/ds.webp", width: 150pt))
  #place(top + center, dx: 240pt, dy: 90pt, image("../public/images/playstation.webp", width: 250pt))
...
#place(center, dy: 10pt, figure(
  image("../public/images/tiny-nes.png", width: 300pt),
...
#place(center, dx: -200pt, dy: 5pt, figure(
  image("../public/images/fpga-gameboy.png", height: 200pt),
...
#place(center, dx: 140pt, dy: 5pt, figure(
  image("../public/images/monster-6502.jpg", width: 300pt),
...
#place(center, dx: -200pt, dy: 20pt, figure(
  image("../public/images/ps1-web-emulator.png", height: 280pt),
  caption: [#link("https://github.com/maxpoletaev/nupsx")[nuPSX]: Web-based PS1 emulator running Crash Bandicoot],
))

#place(center, dx: 200pt, dy: 20pt, figure(
  image("../public/images/visual-6502.png", width: 370pt),
...
#place(top + left, dy: 130pt, figure(
  image("../public/images/pokemon-red-android.png", width: 400pt),
  caption: [Pokémon Red running on Android],
))

#place(top + right, dy: 130pt, figure(
  image("../public/images/pokemon-red-windows-7.jpg", width: 380pt),
...
#place(center, dy: 20pt, figure(
  image("../public/images/game-emu-anatomy.png", width: 380pt),
...
#place(center, dy: 50pt, figure(
  image("../public/images/nes-motherboard-unmarked.webp", width: 400pt),
...
#place(center, dy: 50pt, figure(
  image("../public/images/nes-motherboard-marked.webp", width: 400pt),
...
#place(top + left, dy: 50pt, figure(
  image("../public/images/nes-cartridges.jpg", width: 400pt),
  caption: [NES cartridges],
))

#place(top + right, dx: -50pt, dy: 50pt, figure(
  image("../public/images/nes-cartridges-internal-unmarked.webp", width: 250pt),
  caption: [NES cartridge chip],
))

#place(top + right, dx: -30pt, dy: 200pt, figure(
  image("../public/images/nes-cartridges-internal-marked.webp", width: 250pt),
...
#place(center, dx: -150pt, dy: 60pt, figure(
  image("../public/images/nes-rom-dumper.jpg", width: 300pt),
  caption: [NES ROM dumper],
))

#place(center, dx: 200pt, dy: 80pt, figure(
  image("../public/images/custom-n64-rom-dumper.jpg", width: 300pt),
...
#place(center, dx: -200pt, dy: 20pt, figure(
  image("../public/images/ines.png", height: 370pt),
  caption: [#link("https://linux.die.net/man/1/xxd")[`xxd`] preview of iNES file],
))

#place(center, dx: 200pt, dy: 20pt, figure(
  image("../public/images/ines-header.png", width: 350pt),
  caption: [iNES header],
))
...
#place(center, dx: -150pt, dy: 20pt, figure(
  image("../public/images/nes-cpu.png", width: 500pt),
  caption: [Ricoh 2A03 memory map and registers],
))

#place(center, dx: 220pt, dy: 120pt, figure(
  image("../public/images/cpu-status-flags.png", width: 400pt),
))
